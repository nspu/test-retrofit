...
data class Item(
        ...
        private var hideFromAll: Boolean? = null,
        private var inStore: Boolean? = null,
        private var into: List<String>? = null,
        var id: Int? = null,
        var stats: ItemInventoryDataStats? = null,
        private var colloq: String? = null,
        var maps: Map<String, Boolean>? = null,
        private var specialRecipe: Int? = null,
        var image: Image? = null,
        var description: String? = null,
        var tags: List<String>? = null,
        var effect: Map<String, String>? = null,
        private var requiredChampion: String? = null,
        var from: List<String>? = null,
        var group: String? = null,
        private var consumeOnFull: Boolean? = null,
        var name: String? = null,
        private var consumed: Boolean? = null,
        var sanitizedDescription: String? = null,
        private var depth: Int? = null,
        private var stacks: Int? = null
) : Parcelable {
